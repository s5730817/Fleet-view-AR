  ...
  engine: [
    {
      ...
      inspectionStep: "Check engine gaskets and seals for oil leaks",
    ...
    },
    {
      ...
      inspectionStep: "Check coolant level, thermostat, and fan operation",
      recommendedAction: "repair",
      priority: "high",
    ...
    },
    {
      ...
      inspectionStep: "Check engine mount condition for excessive vibration",
  ...
  brakes: [
    {
      ...
      inspectionStep: "Check brake pad thickness on all calipers",
      recommendedAction: "replacement",
      priority: "high",
    ...
    },
    {
      ...
      inspectionStep: "Check brake lines and calipers for fluid leaks",
      recommendedAction: "repair",
      priority: "high",
    ...
    },
    {
      ...
      inspectionStep: "Check ABS wheel speed sensors and harness condition",
      recommendedAction: "repair",
      priority: "medium",
  ...
  tires: [
    {
      ...
      inspectionStep: "Measure tread depth across all tyres",
      recommendedAction: "replacement",
      priority: "medium",
    ...
    },
    {
      ...
      inspectionStep: "Inspect tyre sidewalls for cuts, bulges, or impact damage",
      recommendedAction: "replacement",
      priority: "high",
    ...
    },
    {
      ...
      inspectionStep: "Check tyre inflation and inspect for slow punctures",
      recommendedAction: "repair",
      priority: "medium",
  ...
  battery: [
    {
      ...
      inspectionStep: "Test battery voltage under rest and cranking load",
      recommendedAction: "repair",
      priority: "medium",
    ...
    },
    {
      ...
      inspectionStep: "Inspect battery terminals for corrosion and secure contact",
      recommendedAction: "repair",
      priority: "low",
    ...
    },
    {
      ...
      inspectionStep: "Load-test battery cells for capacity and charge retention",
      recommendedAction: "replacement",
      priority: "high",
  ...
  suspension: [
    {
      ...
      inspectionStep: "Inspect shock absorbers for fluid loss or visible damage",
      recommendedAction: "replacement",
      priority: "medium",
    ...
    },
    {
      ...
      inspectionStep: "Check air bag suspension pressure and fittings for leaks",
      recommendedAction: "repair",
      priority: "high",
    ...
    },
    {
      ...
      inspectionStep: "Check suspension bushings and joints for play or split rubber",
      recommendedAction: "replacement",
      priority: "medium",
  ...
  cooling: [
    {
      ...
      inspectionStep: "Inspect hoses, radiator, and pump for coolant leaks",
      recommendedAction: "repair",
      priority: "high",
    ...
    },
    {
      ...
      inspectionStep: "Verify cooling fan engages correctly at operating temperature",
      recommendedAction: "repair",
      priority: "medium",
    ...
    },
    {
      ...
      inspectionStep: "Check thermostat operation through warm-up cycle",
      recommendedAction: "replacement",
      priority: "medium",
  ...
  transmission: [
    {
      ...
      inspectionStep: "Inspect transmission pan, gasket, and cooler lines for leaks",
      recommendedAction: "repair",
      priority: "high",
    ...
    },
    {
      ...
      inspectionStep: "Check shift quality and transmission fluid condition",
      recommendedAction: "repair",
      priority: "medium",
    ...
    },
    {
      ...
      inspectionStep: "Check for clutch pack slip under load",
      recommendedAction: "replacement",
      priority: "high",
  ...
  electrical: [
    {
      ...
      inspectionStep: "Inspect harness routing for chafing or open circuits",
      recommendedAction: "repair",
      priority: "medium",
    ...
    },
    {
      ...
      inspectionStep: "Verify all exterior and cabin lighting circuits",
      recommendedAction: "replacement",
      priority: "low",
    ...
    },
    {
      ...
      inspectionStep: "Check sensor connections and CAN bus communication",
      recommendedAction: "repair",
      priority: "high",
...
const getIssueTypeOptionsForPart = (partCode, baseInstructions = []) => {
  ...
  return issueTypes.map((issueType) => ({
    ...
    inspectionStep: issueType.inspectionStep || null,
    excludeFromInspection: issueType.excludeFromInspection || false,
